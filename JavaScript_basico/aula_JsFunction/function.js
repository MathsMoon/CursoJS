/* Funções em geral no Javascript 
    ...
    Dentre os outros tipos de funções, temos a Arrow function. Uma versão reduzida do modelo tradicional que tem como propriedade já
    a naturalidade de ser criada para uma variável ou parametro, seu comportamento em relação ao This se difere das demais por não 
    se utilizar da palavra reservada function.
