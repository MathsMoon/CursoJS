...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _generate_password__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./generate_password */ "./src/modules/generate_password.js");


//Tabela com as flags:
var passwordOutput = document.querySelector('.showingPassword');
var qtdChar = document.querySelector('.qtd-characters');
var chkLCLetters = document.querySelector('.chk-minusculas');
var chkUpCLetters = document.querySelector('.chk-maiusculas');
var chkNums = document.querySelector('.chk-nums');
var chkSimbols = document.querySelector('.chk-simbols');
...
function gettingThePassword() {
  var password = (0,_generate_password__WEBPACK_IMPORTED_MODULE_0__["default"])(qtdChar.value, chkUpCLetters.checked, chkLCLetters.checked, chkNums.checked, chkSimbols.checked);
  return password || 'Nada Selecionado!';
}

/***/ }),

/***/ "./src/modules/generate_password.js":
/*!******************************************!*\
  !*** ./src/modules/generate_password.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var getnums = function getnums() {
  return String.fromCharCode(rand(48, 57));
};
var getUpperCaseLetters = function getUpperCaseLetters() {
  return String.fromCharCode(rand(65, 90));
};
var getLowerCaseLetters = function getLowerCaseLetters() {
  return String.fromCharCode(rand(97, 122));
};
var simbols = '+-*/?|\\!@#$%¨&*(){}[]><,.;:_-=+§';
var getSimbol = function getSimbol() {
  return simbols[rand(0, simbols.length)];
};
function generatePassword(qtd, upc, lc, num, simb) {
  var password = [];
  qtd = Number(qtd);
  for (var i = 0; i < qtd; i++) {
